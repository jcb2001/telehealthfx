    ...
    <section className="section" style={{ minHeight: '60vh', paddingTop: 120 }}>
      ...
      <div className="container" style={{ maxWidth: 800 }}>
        ...
        <div className="blog-content" style={{ fontSize: 18, lineHeight: 1.7, color: 'var(--ink-2)' }}>
          <p>If you buy a cheap Berberine patch from a generic supplement dropshipper online, you will almost always see the same marketing claim printed on the box: “Lasts for 72 Hours.” It sounds great. You stick it on, forget about it for three days, and let your metabolism do the work.</p>
          <p>The promise is seductive—consistent metabolic support without the hassle of daily pills or the gastrointestinal upset that often accompanies high-dose oral Berberine (as we covered in our <a href="/blog/berberine">detailed guide to avoiding Berberine Belly</a>). Yet, as a bio-systems researcher with more than a decade auditing supplement delivery systems, my job is to look past the marketing and audit the actual biology.</p>
          ...
          <div style={{ marginTop: 60, paddingTop: 40, borderTop: '1px solid var(--line-soft)', fontSize: 12, color: 'var(--ink-3)' }}>
            ...
            <ol style={{ paddingLeft: 20, lineHeight: 1.5, display: 'flex', flexDirection: 'column', gap: 8 }}>
              <li>Ai, X., et al. (2022). Berberine: A review of its pharmacokinetics properties and clinical studies in diabetes mellitus. <em>Biomedicine & Pharmacotherapy</em>.</li>
              <li>Asbaghi, O., et al. (2020). The effect of berberine supplementation on obesity parameters and metabolic syndrome components. <em>Phytotherapy Research</em>.</li>
              <li>Berner, B., & John, V. A. (1994). Pharmacokinetic characterisation of transdermal delivery systems. <em>Clinical Pharmacokinetics</em>.</li>
              <li>Bird, D., & Binks, P. (2020). Transdermal patches: An overview. <em>Drug Delivery and Translational Research</em>.</li>
              <li>Buchanan, B., et al. (2018). Comparative pharmacokinetics and safety assessment of transdermal berberine and dihydroberberine in rats. <em>Nutrients</em>.</li>
              <li>Cui, X., et al. (2024). Visualizing the transdermal delivery of berberine loaded within chitosan microneedles using mass spectrometry imaging. <em>Journal of Pharmaceutical Analysis</em>.</li>
              <li>European Medicines Agency. (2014). Guideline on quality of transdermal patches.</li>
              <li>Liu, D., et al. (2025). Efficacy and safety of berberine on the components of metabolic syndrome. <em>Frontiers in Pharmacology</em>.</li>
              <li>Mayangsari, F., et al. (2022). Development of transfersomal emulgel to enhance the transdermal delivery of berberine. <em>Journal of Applied Pharmaceutical Science</em>.</li>
              <li>Moon, J. M., et al. (2022). Absorption kinetics of berberine and dihydroberberine in humans. <em>Nutrients</em>.</li>
              <li>Ramadon, D., et al. (2021). Enhancement strategies for transdermal drug delivery systems: Current trends and applications. <em>Drug Delivery and Translational Research</em>.</li>
              <li>Shen, S., et al. (2025). Berberine hydrochloride-loaded liposomes-in-hydrogel microneedles achieve the efficient treatment for psoriasis. <em>Materials Today Bio</em>.</li>
              <li>Singh, I., et al. (2011). Performance of transdermal therapeutic systems: A review. <em>Indian Journal of Pharmaceutical Sciences</em>.</li>
              <li>Ye, Y., et al. (2021). Efficacy and safety of berberine alone for several metabolic disorders. <em>Frontiers in Pharmacology</em>.</li>
              <li>Yin, J., et al. (2008). Efficacy of berberine in patients with type 2 diabetes mellitus. <em>Metabolism</em>.</li>
              <li>Zhang, X., et al. (2024). Design of berberine hydrochloride sustained-release cold sol using HPMC. <em>International Journal of Biological Macromolecules</em>.</li>
            </ol>
          </div>
