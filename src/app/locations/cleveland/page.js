...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Ohio-licensed physicians in Cleveland. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Cleveland | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Cleveland, Ohio residents. Ohio-licensed physicians. From $99/mo (1st month promo).",
