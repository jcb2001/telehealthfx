...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Alabama-licensed physicians in Dothan. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Dothan | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Dothan, Alabama residents. Alabama-licensed physicians. From $99/mo (1st month promo).",
