...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Kansas-licensed physicians in Topeka. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Topeka | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Topeka, Kansas residents. Kansas-licensed physicians. From $99/mo (1st month promo).",
