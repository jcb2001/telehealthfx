...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Oklahoma-licensed physicians in Lawton. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Lawton | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Lawton, Oklahoma residents. Oklahoma-licensed physicians. From $99/mo (1st month promo).",
