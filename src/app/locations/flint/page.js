...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Michigan-licensed physicians in Flint. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Flint | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Flint, Michigan residents. Michigan-licensed physicians. From $99/mo (1st month promo).",
