...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Texas-licensed physicians in El Paso. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in El Paso | Telehealth FX",
    description: "Clinical GLP-1 telehealth for El Paso, Texas residents. Texas-licensed physicians. From $99/mo (1st month promo).",
