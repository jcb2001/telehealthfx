...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Hawaii-licensed physicians in Honolulu. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Honolulu | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Honolulu, Hawaii residents. Hawaii-licensed physicians. From $99/mo (1st month promo).",
