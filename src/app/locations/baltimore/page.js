...
export default function BaltimorePage() {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://telehealthfx.com/locations/baltimore#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Baltimore",
            "item": "https://telehealthfx.com/locations/baltimore"
          }
        ]
      },
      {
      ...
      {
        "@type": "Service",
        "@id": "https://telehealthfx.com/locations/baltimore#service",
        "name": "GLP-1 Weight Loss Program - Baltimore",
        "description": "Clinical telehealth weight loss program delivering compounded Semaglutide and Tirzepatide to Baltimore, Maryland residents. Regulated under Maryland Board of Physicians standards with physician evaluation, prescription, and cold-shipped medication.",
        "provider": {
          "@id": "https://telehealthfx.com/locations/baltimore#clinic"
        },
        "areaServed": {
