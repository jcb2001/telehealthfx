...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Massachusetts-licensed physicians in Boston. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Boston | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Boston, Massachusetts residents. Massachusetts-licensed physicians. From $99/mo (1st month promo).",
