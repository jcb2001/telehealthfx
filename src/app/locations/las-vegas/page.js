...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Nevada-licensed physicians in Las Vegas. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Las Vegas | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Las Vegas, Nevada residents. Nevada-licensed physicians. From $99/mo (1st month promo).",
