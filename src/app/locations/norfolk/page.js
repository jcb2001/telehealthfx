...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Virginia-licensed physicians in Norfolk. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Norfolk | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Norfolk, Virginia residents. Virginia-licensed physicians. From $99/mo (1st month promo).",
