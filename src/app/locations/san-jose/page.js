...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by California-licensed physicians in San Jose. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in San Jose | Telehealth FX",
    description: "Clinical GLP-1 telehealth for San Jose, California residents. California-licensed physicians. From $99/mo (1st month promo).",
