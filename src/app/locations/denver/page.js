...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Colorado-licensed physicians in Denver. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Denver | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Denver, Colorado residents. Colorado-licensed physicians. From $99/mo (1st month promo).",
