...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Missouri-licensed physicians in Springfield. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Springfield | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Springfield, Missouri residents. Missouri-licensed physicians. From $99/mo (1st month promo).",
