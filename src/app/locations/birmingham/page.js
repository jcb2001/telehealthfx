...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Alabama-licensed physicians in Birmingham. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Birmingham | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Birmingham, Alabama residents. Alabama-licensed physicians. From $99/mo (1st month promo).",
