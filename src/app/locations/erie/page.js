...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Pennsylvania-licensed physicians in Erie. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Erie | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Erie, Pennsylvania residents. Pennsylvania-licensed physicians. From $99/mo (1st month promo).",
