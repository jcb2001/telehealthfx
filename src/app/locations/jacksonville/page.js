...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Florida-licensed physicians in Jacksonville. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Jacksonville | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Jacksonville, Florida residents. Florida-licensed physicians. From $99/mo (1st month promo).",
