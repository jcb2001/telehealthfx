...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Indiana-licensed physicians in Fort Wayne. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Fort Wayne | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Fort Wayne, Indiana residents. Indiana-licensed physicians. From $99/mo (1st month promo).",
