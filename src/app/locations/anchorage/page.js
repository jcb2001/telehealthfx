...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Alaska-licensed physicians in Anchorage. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Anchorage | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Anchorage, Alaska residents. Alaska-licensed physicians. From $99/mo (1st month promo).",
