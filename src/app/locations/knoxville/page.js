...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Tennessee-licensed physicians in Knoxville. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Knoxville | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Knoxville, Tennessee residents. Tennessee-licensed physicians. From $99/mo (1st month promo).",
