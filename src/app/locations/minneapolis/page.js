...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Minnesota-licensed physicians in Minneapolis. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Minneapolis | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Minneapolis, Minnesota residents. Minnesota-licensed physicians. From $99/mo (1st month promo).",
