...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Arkansas-licensed physicians in Little Rock. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Little Rock | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Little Rock, Arkansas residents. Arkansas-licensed physicians. From $99/mo (1st month promo).",
