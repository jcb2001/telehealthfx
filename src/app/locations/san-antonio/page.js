...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Texas-licensed physicians in San Antonio. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in San Antonio | Telehealth FX",
    description: "Clinical GLP-1 telehealth for San Antonio, Texas residents. Texas-licensed physicians. From $99/mo (1st month promo).",
