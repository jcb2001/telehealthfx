...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Louisiana-licensed physicians in Lake Charles. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Lake Charles | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Lake Charles, Louisiana residents. Louisiana-licensed physicians. From $99/mo (1st month promo).",
