...
export const metadata = {
  ...
  description: "quality-verified compounded Semaglutide prescribed by Rhode Island-licensed physicians in Providence. From $99/mo (1st month promo) with overnight cold-pack delivery. Affirm available.",
  openGraph: {
    title: "GLP-1 Weight Loss in Providence | Telehealth FX",
    description: "Clinical GLP-1 telehealth for Providence, Rhode Island residents. Rhode Island-licensed physicians. From $99/mo (1st month promo).",
