...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://telehealthfx.com/blog/glp1-pcos-insulin-resistance-2026/'
  }
};
export default function Page() {
  const jsonLd = { "@context": "https://schema.org", "@type": "MedicalWebPage",
    "description": metadata.description, "headline": "GLP-1 and PCOS Insulin Resistance", "author": { "@type": "Person", "name": "Julian Mercer, M.S." }, "publisher": { "@type": "Organization", "name": "Telehealth FX" } };
