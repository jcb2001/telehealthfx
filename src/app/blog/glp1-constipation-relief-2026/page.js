...
export const metadata = {
  ...
  openGraph: {
    title: "GLP-1 and Constipation: The #1 Side Effect Nobody Warns You About",
    description: "Constipation affects 24% of GLP-1 patients. The complete evidence-based relief protocol.",
    images: [{ url: "https://telehealthfx.com/assets/glp1-constipation-relief-featured.png", width: 1200, height: 630, alt: "GLP-1 Constipation Relief Protocol" }],
  },
};
  ...
  "@graph": [
    {
      ...
      "headline": "GLP-1 and Constipation: The #1 Side Effect Nobody Warns You About (And How to Fix It)",
      "description": "Constipation affects 24% of GLP-1 patients. The complete evidence-based relief protocol — fiber, hydration, magnesium, and when to contact your clinician.",
    ...
    {
      "@type": "Article",
      "@id": "https://telehealthfx.com/blog/glp1-constipation-relief-2026/#newsarticle",
      "headline": "GLP-1 and Constipation: The #1 Side Effect Nobody Warns You About",
      "image": "https://telehealthfx.com/assets/glp1-constipation-relief-featured.png",
      "datePublished": "2026-05-11",
      "dateModified": "2026-05-11",
      "author": {
