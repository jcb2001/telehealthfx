...
export default function Page() {
  const jsonLd = { "@context": "https://schema.org", "@graph": [{ "@type": "MedicalWebPage", "headline": "Is Compounded Semaglutide Safe?", "author": { "@type": "Person", "name": "Julian Mercer, M.S." }, "publisher": { "@type": "Organization", "name": "Telehealth FX" } }, { "@type": "FAQPage", "mainEntity": [{ "@type": "Question", "name": "Is compounded semaglutide FDA-approved?", "acceptedAnswer": { "@type": "Answer", "text": "No. Compounded medications are not FDA-approved — they are FDA-regulated through Section 503A, the same framework for compounded thyroid and hormone medications." } }] }] };
