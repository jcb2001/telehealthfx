import { BlogTravelingWithTestosterone2026 } from '@/components/blog-traveling-with-testosterone-2026';
...
export default function Page() {
  ...
  "@type": "MedicalWebPage",
  "name": "Traveling with Testosterone: TSA Rules and International Guidelines",
  "description": "A definitive guide to flying domestically and internationally with TRT medication. Learn TSA rules for needles, vials, and medical freezer packs.",
  "publisher": {
    "@type": "Organization",
    "name": "Telehealth FX",
  ...
  "mainEntity": {
    ...
    "image": "https://telehealthfx.com/assets/traveling_with_testosterone.png",
    "offers": {
      "@type": "Offer",
  ...
  return (
    <>
      ...
      />
      <BlogTravelingWithTestosterone2026 />
    </>
  );
}
