...
export const metadata = { title: "GLP-1 and Fatty Liver Disease: How Semaglutide Reverses NAFLD/MASH (2026)", description: "Semaglutide resolved MASH in 59% of patients. How GLP-1 reduces liver fat, normalizes ALT/AST, and may prevent liver failure." };
