...
export default function Page() {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "FAQPage",
        "@id": "https://telehealthfx.com/blog/glp-1-muscle-loss-the-hidden-risk-nobodys-talking/#faq",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the main clinical takeaway regarding GLP-1 Muscle Loss: The Hidden Risk Nobody's Talking About (2026 Clinical Guide)?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "This article provides a comprehensive clinical breakdown of GLP-1 Muscle Loss: The Hidden Risk Nobody's Talking About (2026 Clinical Guide), detailing the exact mechanisms, safety protocols, and evidence-based research required for optimal metabolic health."
            }
          },
          {
            "@type": "Question",
