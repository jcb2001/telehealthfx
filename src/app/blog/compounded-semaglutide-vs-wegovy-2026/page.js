...
export const metadata = {
  ...
  openGraph: { title: "Compounded Semaglutide vs Wegovy: 2026 Cost Comparison", description: "Compounded semaglutide, up to 90% savings. Complete side-by-side analysis.", images: [{ url: "https://telehealthfx.com/assets/compounded-semaglutide-vs-wegovy-featured.png", width: 1200, height: 630, alt: "Compounded vs Wegovy" }] },
};
export default function Page() {
  ...
  return (<><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} /><BlogCompoundedVsWegovy /></>);
}
