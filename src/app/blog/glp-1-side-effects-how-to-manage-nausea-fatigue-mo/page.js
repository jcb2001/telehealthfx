...
export default function Page() {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "FAQPage",
        "@id": "https://telehealthfx.com/blog/glp-1-side-effects-how-to-manage-nausea-fatigue-mo/#faq",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the main clinical takeaway regarding GLP-1 Side Effects: How to Manage Nausea, Fatigue & More?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "This article provides a comprehensive clinical breakdown of GLP-1 Side Effects: How to Manage Nausea, Fatigue & More, detailing the exact mechanisms, safety protocols, and evidence-based research required for optimal metabolic health."
            }
          },
          {
            "@type": "Question",
