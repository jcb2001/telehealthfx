...
export const metadata = { title: "GLP-1 and Sleep: How Semaglutide Improves Sleep Quality (2026)", description: "GLP-1 improves sleep quality, reduces sleep apnea (63% AHI reduction), and creates a virtuous weight loss cycle. Clinical data on semaglutide and sleep." };
