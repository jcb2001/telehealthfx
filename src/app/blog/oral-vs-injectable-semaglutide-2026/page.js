...
export const metadata = { title: "Oral Semaglutide (Rybelsus) vs Injectable: Is the GLP-1 Pill Worth It? (2026)", description: "Oral semaglutide has 1% bioavailability vs injectable's 89%. Cost, weight loss, convenience comparison. Why injectable wins on every metric except needle fear.", openGraph: { title: "Oral vs Injectable Semaglutide: The Honest Comparison", description: "1% vs 89% bioavailability. $1,000 vs $199/month. The numbers speak." } };
export default function Page() {
  const jsonLd = { "@context": "https://schema.org", "@type": "MedicalWebPage", "headline": "Oral vs Injectable Semaglutide", "author": { "@type": "Person", "name": "Julian Mercer, M.S." }, "publisher": { "@type": "Organization", "name": "Telehealth FX" } };
  return (<><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} /><BlogOralVsInjectableSemaglutide /></>);
}
