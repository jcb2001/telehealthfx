...
export default function Page() {
  ...
  "@graph": [
    {
      "@type": "MedicalWebPage",
      "@id": "https://telehealthfx.com/blog/glp1-travel-guide-2026/#article",
      "headline": "Traveling with GLP-1: The Complete Guide to Flying, Storage, and Staying on Protocol Abroad",
      "description": "Complete guide to traveling with semaglutide and tirzepatide — TSA rules, temperature storage, international travel, and essential travel kit.",
      "image": "https://telehealthfx.com/assets/glp1-travel-guide-featured.png",
    ...
    {
      "@type": "Article",
      "@id": "https://telehealthfx.com/blog/glp1-travel-guide-2026/#newsarticle",
      "headline": "Traveling with GLP-1: Flying, Storage & Staying on Protocol Abroad",
      "image": "https://telehealthfx.com/assets/glp1-travel-guide-featured.png",
      "datePublished": "2026-05-11",
      "dateModified": "2026-05-11",
      "author": {
    ...
    {
      "@type": "FAQPage",
      "@id": "https://telehealthfx.com/blog/glp1-travel-guide-2026/#faq",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Can I inject on the airplane?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. There is no rule against injecting medication on an aircraft. Choose the lavatory for privacy and hygiene. Dispose of needles in your travel sharps container — never in the airplane trash."
          }
        },
        {
          "@type": "Question",
          "name": "What if my medication gets warm during travel?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "In-use semaglutide pens can tolerate up to 86°F for up to 56 days. Brief exposure above this threshold may not destroy the medication, but repeated or prolonged heat exposure reduces potency."
          }
        },
        {
          "@type": "Question",
          "name": "Can I shift my injection day for travel?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Semaglutide and tirzepatide have long half-lives. You can safely shift your injection day by 1–2 days in either direction without affecting efficacy."
          }
        }
      ]
    },
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "GLP-1 Travel Guide",
          "item": "https://telehealthfx.com/blog/glp1-travel-guide-2026/"
        }
      ]
    },
    {
