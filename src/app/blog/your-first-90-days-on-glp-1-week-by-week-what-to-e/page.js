...
export default function Page() {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "FAQPage",
        "@id": "https://telehealthfx.com/blog/your-first-90-days-on-glp-1-week-by-week-what-to-e/#faq",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the main clinical takeaway regarding Your First 90 Days on GLP-1: Week-by-Week What to Expect (2026 Clinical Guide)?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "This article provides a comprehensive clinical breakdown of Your First 90 Days on GLP-1: Week-by-Week What to Expect (2026 Clinical Guide), detailing the exact mechanisms, safety protocols, and evidence-based research required for optimal metabolic health."
            }
          },
          {
            "@type": "Question",
