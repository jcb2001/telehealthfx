...
export default function Page() {
  const jsonLd = {
    ...
    "@graph": [
      ...
      {
        "@type": "FAQPage",
        "@id": "https://telehealthfx.com/blog/how-to-choose-a-telehealth-weight-loss-program-and/#faq",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the main clinical takeaway regarding How to Choose a Telehealth Weight Loss Program (And Avoid the Scams) (2026 Clinical Guide)?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "This article provides a comprehensive clinical breakdown of How to Choose a Telehealth Weight Loss Program (And Avoid the Scams) (2026 Clinical Guide), detailing the exact mechanisms, safety protocols, and evidence-based research required for optimal metabolic health."
            }
          },
          {
            "@type": "Question",
