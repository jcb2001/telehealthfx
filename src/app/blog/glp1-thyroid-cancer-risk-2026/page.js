...
export default function Page() {
  const jsonLd = { "@context": "https://schema.org", "@graph": [
    { "@type": "MedicalWebPage",
    "description": metadata.description, "headline": "GLP-1 and Thyroid Cancer Risk: What the Black Box Warning Means", "image": "https://telehealthfx.com/assets/glp1-thyroid-cancer-risk-featured.png", "author": { "@type": "Person", "name": "Julian Mercer, M.S." }, "publisher": { "@type": "Organization", "name": "Telehealth FX" } },
