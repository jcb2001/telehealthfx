...
export default function Page() {
  const jsonLd = { "@context": "https://schema.org", "@graph": [
    ...
    { "@type": "FAQPage", "@id": "https://telehealthfx.com/blog/ozempic-alternatives-no-insurance-2026/#faq", "mainEntity": [
      { "@type": "Question", "name": "What is the cheapest alternative to Ozempic?", "acceptedAnswer": { "@type": "Answer", "text": "Compounded semaglutide through all-inclusive telehealth ($150–$399/month) offers the same molecule at a fraction of branded price." } },
