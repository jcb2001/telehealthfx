...
<p>Telehealth FX is an Equal Opportunity Employer. We celebrate diversity and are committed to creating an inclusive environment for all employees regardless of race, color, religion, sex, sexual orientation, gender identity, national origin, veteran status, disability, or age.</p>`,
  ...
  return (
    <>
      ...
      {applicationState && (
        <div style={{
          backgroundColor: '#1F3529', color: '#FBF8F3', padding: '12px 0',
          fontSize: '13px', borderBottom: '1px solid rgba(255,255,255,0.1)'
        }}>
          <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span style={{
                display: 'inline-block', width: '8px', height: '8px', backgroundColor: '#4EBE7B',
                borderRadius: '50%', boxShadow: '0 0 0 4px rgba(78, 190, 123, 0.25)'
              }}></span>
              <span>
            ...
            <button 
              ...
              style={{ fontSize: '12px', fontWeight: 600, color: '#FBF8F3', textDecoration: 'underline', backgroundColor: 'transparent', border: 'none', cursor: 'pointer' }}
            >
          ...
          <div className="container">
            <div style={{ maxWidth: 880 }}>
              ...
              {applicationState ? (
                ...
                <div style={{
                  backgroundColor: '#F4EFE6', border: '2px solid var(--brand)',
                  borderRadius: '20px', padding: '32px', boxShadow: '0 8px 24px rgba(46, 74, 59, 0.08)'
                }}>
                  <div style={{
                    display: 'inline-flex', alignItems: 'center', gap: '6px',
                    fontFamily: 'var(--mono)', fontSize: '11px', letterSpacing: '0.1em',
                    color: 'var(--brand)', backgroundColor: 'rgba(46, 74, 59, 0.1)',
                    padding: '6px 12px', borderRadius: '999px', marginBottom: '16px', fontWeight: 700
                  }}>
                    <span>✅</span>
                    <span>APPLICATION SUBMITTED & RECEIVED</span>
                  </div>
                  
                  <h1 className="serif" style={{ fontSize: 36, marginBottom: 12, color: 'var(--ink)' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', backgroundColor: '#FFFFFF', border: '1px solid var(--line-soft)', borderRadius: '12px', padding: '16px', marginBottom: '24px' }}>
                    <div>
                      <div className="mono" style={{ fontSize: '10px', letterSpacing: '0.08em', color: 'var(--ink-3)', marginBottom: '4px' }}>APPLICATION REF</div>
                    ...
                    <div>
                      <div className="mono" style={{ fontSize: '10px', letterSpacing: '0.08em', color: 'var(--ink-3)', marginBottom: '4px' }}>CANDIDATE EMAIL</div>
                    ...
                    <div>
                      <div className="mono" style={{ fontSize: '10px', letterSpacing: '0.08em', color: 'var(--ink-3)', marginBottom: '4px' }}>APPLICATION STATUS</div>
                ...
                <>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
                    ...
                    <span style={{ fontSize: '13px', color: 'var(--ink-3)' }}>⚡ Takes less than 60 seconds with instant AI resume upload</span>
                  </div>
                </>
              )}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 340px', gap: '48px', alignItems: 'start' }}>
              ...
              <div style={{ minWidth: 0 }}>
                ...
                <div style={{ background: 'linear-gradient(135deg, #1F3529 0%, #2E4A3B 100%)', color: 'white', padding: '40px', borderRadius: '20px', marginTop: '60px' }}>
                  {applicationState ? (
                    <div>
                      <h3 className="serif" style={{ fontSize: 28, color: 'white', marginBottom: 12 }}>Application Submitted!</h3>
                      ...
                      <button className="btn btn-secondary btn-lg" style={{ color: 'white', borderColor: 'rgba(255,255,255,0.3)' }} onClick={() => setIsModalOpen(true)}>
                        View Submitted Application Receipt ➔
                      </button>
                    </div>
                  ) : (
                    <div>
                      <h3 className="serif" style={{ fontSize: 28, color: 'white', marginBottom: 12 }}>Ready to Lead the GLP-1 Healthcare Revolution?</h3>
                      <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.85)', marginBottom: 24 }}>
                        Take the next step in your sales career with Telehealth FX. Click below to open our application modal and upload your resume for instant processing.
                      </p>
                      <button 
                        className="btn btn-primary btn-lg" 
                        onClick={() => setIsModalOpen(true)}
