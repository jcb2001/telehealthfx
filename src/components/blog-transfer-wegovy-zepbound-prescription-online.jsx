...
export function BlogTransferWegovyOnline() {
  return (
    <section className="section" style={{ minHeight: '60vh', paddingTop: 120, paddingBottom: 100 }}>
      <div className="container" style={{ maxWidth: 840, margin: '0 auto', padding: '0 20px' }}>
        ...
        <div style={{ borderRadius: 16, overflow: 'hidden', marginBottom: 32, boxShadow: '0 8px 30px rgba(0,0,0,0.08)' }}>
          <Image
            src="/assets/transfer_wegovy_online.jpg"
            alt="Patient and clinician reviewing online prescription transfer verification on tablet"
            width={1200}
            height={675}
        ...
        <AIQuickSummaryAction
          ...
          keyPoints={[
            ...
            { label: "Transparent Pricing", value: "Then $190–$199/mo (Semaglutide) or $214–$299/mo (Tirzepatide)" },
        ...
        <DirectAnswerSnippet
          question="How can you transfer an existing Wegovy or Zepbound prescription online?"
          answer="Transferring a Wegovy or Zepbound prescription online is seamless through Telehealth FX. Patients submit existing prescription details or packaging for asynchronous physician evaluation under Section 503A of the FD&C Act. Compounded semaglutide from $99 first month promo, then $190/mo, is fulfilled by licensed 503A pharmacies with free cold shipping and $0 membership dues."
          keyTakeaways={[
            { "label": "Regulatory Framework", "value": "100% Legal 503A Compounding (21 U.S.C. § 353a)" },
            { "label": "Direct Cash Price", "value": "$99 / 1st mo (Then $190–$199/mo (Semaglutide) or $214–$299/mo (Tirzepatide))" },
            { "label": "Affirm Financing", "value": "Pay over time starting from ~$25/month" },
        ...
        <div className="blog-content" style={{ fontSize: 18, lineHeight: 1.75, color: 'var(--ink-2, #333C36)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, margin: '24px 0 40px' }}>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>Can I transfer my existing Wegovy or Zepbound prescription to Telehealth FX?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>Yes. You can upload photos of your current prescription label or previous medical records. A licensed telehealth physician reviews your dosing history to transition you directly into compounded semaglutide or tirzepatide without resetting your titration.</p>
            </div>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>Will I have to start over at the lowest starter dose when transferring?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>No. If you are already established on maintenance doses such as 1.0mg, 1.7mg, or 2.4mg of semaglutide (or 5mg to 15mg of tirzepatide), our doctors can match your current dose to ensure continuous therapeutic appetite suppression.</p>
            </div>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>How does compounded semaglutide compare to brand Wegovy in cost?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>While brand Wegovy costs over $1,349 per month without insurance, Telehealth FX offers 503A compounded semaglutide starting at an introductory $99 first month promo, then $190 to $199 monthly with zero subscription fees, free doctor care, and free shipping.</p>
            </div>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>How quickly will my medication arrive after prescription transfer?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>Physician evaluation is completed within 24 hours. Once approved, your order is compounded and shipped via 2-day temperature-monitored cold-chain courier directly to your door.</p>
            </div>
          </div>
