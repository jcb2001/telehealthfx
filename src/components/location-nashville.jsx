    ...
    <div style={{ background: '#FBF8F3', overflow: 'hidden' }}>
      ...
      <InteractiveFAQ
        faqs={[
          ...
          { q: "I'm a musician with no insurance. How does payment work?", a: "Telehealth FX is a self-pay service starting at just $99 for your first month, with Affirm financing available from $25/mo. No insurance is required, and no membership or consultation fees are added. For Nashville's 1099 music industry workforce, this is designed to be the most accessible clinical pathway available. HSA/FSA funds can also be used." },
