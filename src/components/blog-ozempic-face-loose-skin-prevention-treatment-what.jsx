...
function BlogOzempicFaceLooseSkinPreventionTreatmentWhat() {
  return (
    <>
      ...
      <Head>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"MedicalWebPage","name":"\"<a href="/blog/ozempic-face-loose-skin-prevention-treatment-what" style={{ color: 'var(--brand)', textDecoration: 'underline', fontWeight: 500 }}>Ozempic face</a>\" & Loose Skin: Prevention and Treatment","author":{"@type":"Person","name":"Julian Mercer, M.S.","url":"https://telehealthfx.com/about"},"publisher":{"@type":"Organization","name":"TelehealthFX","logo":{"@type":"ImageObject","url":"https://telehealthfx.com/assets/logo.png"}}}` }} />
      </Head>
