...
function BlogGlp1MuscleLossTheHiddenRiskNobodysTalking() {
  return (
    <>

      <Head>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"MedicalWebPage","name":"GLP-1 <a href="/blog/the-muscle-loss-myth-how-to-protect-your-lean-mass" style={{ color: 'var(--brand)', textDecoration: 'underline', fontWeight: 500 }}>muscle loss</a>: The Hidden Risk on Semaglutide & Tirzepatide","author":{"@type":"Person","name":"Julian Mercer, M.S.","url":"https://telehealthfx.com/about"},"publisher":{"@type":"Organization","name":"TelehealthFX","logo":{"@type":"ImageObject","url":"https://telehealthfx.com/assets/logo.png"}}}` }} />
      </Head>
      ...
      <div className="container" style={{ maxWidth: 800 }}>
        ...
        <div className="blog-content" style={{ fontSize: 18, lineHeight: 1.7, color: 'var(--ink-2)' }}>
          <Image src="/assets/glp1_muscle_loss_featured.png" alt="Glowing anatomical muscle fiber structure next to medical weight loss pen" width={1024} height={1024} style={{ width: '100%', borderRadius: 16, marginBottom: 40, border: '1px solid var(--line-soft)', background: '#111' , height: "auto"}} priority={true} />
...
export { BlogGlp1MuscleLossTheHiddenRiskNobodysTalking };
