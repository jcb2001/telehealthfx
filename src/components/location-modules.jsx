              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 32 }}>
                ...
                <li style={{ display: 'flex', gap: 20 }}>
                  ...
                  <div>
                    ...
                    <span style={{ color: 'var(--ink-2)', fontSize: 15, lineHeight: 1.6 }}>A state-licensed provider reviews your data and writes an FDA-compliant compounding prescription.</span>
                  </div>
                </li>
                <li style={{ display: 'flex', gap: 20 }}>
