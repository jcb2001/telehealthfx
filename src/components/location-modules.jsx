      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div className="row align-items-center justify-content-center text-center">
          <div className="col-lg-10">
            ...
            <a href={SEMAGLUTIDE_URL} style={{ display: 'inline-block', background: '#FBF8F3', color: '#0A0F0D', fontSize: 18, padding: '16px 36px', fontWeight: 600, borderRadius: 100, textDecoration: 'none', boxShadow: '0 8px 30px rgba(251, 248, 243, 0.2)', transition: 'transform 0.2s ease' }}>
              {ctaText}
            </a>
          </div>
        </div>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div className="row align-items-center g-5">
          <div className="col-lg-7">
            ...
            <a href={SEMAGLUTIDE_URL} style={{ display: 'inline-flex', alignItems: 'center', gap: 12, background: '#2ECC71', color: '#000', fontSize: 16, padding: '16px 32px', fontWeight: 600, borderRadius: 100, textDecoration: 'none' }}>
          ...
          <div className="col-lg-5">
            <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 24, padding: 32, backdropFilter: 'blur(20px)' }}>
              <div style={{ marginBottom: 24, paddingBottom: 24, borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                <div style={{ color: '#2ECC71', fontSize: 13, textTransform: 'uppercase', letterSpacing: 1, fontWeight: 600, marginBottom: 8 }}>Logistics Fact</div>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 32 }}>
                ...
                <li style={{ display: 'flex', gap: 20 }}>
                  ...
                  <div>
                    ...
                    <span style={{ color: 'var(--ink-2)', fontSize: 15, lineHeight: 1.6 }}>A state-licensed provider reviews your data and writes an quality-verified compounding prescription.</span>
                  </div>
                </li>
                <li style={{ display: 'flex', gap: 20 }}>
        ...
        <div className="row g-5 align-items-center">
          <div className="col-lg-5 text-center text-lg-start">
            ...
            <p style={{ fontSize: 16, color: 'var(--ink-2)', marginBottom: 32, lineHeight: 1.7 }}>
              Our network fulfills compounded GLP-1 prescriptions to all residential addresses across the {cityName} metropolitan statistical area.
            </p>
  ...
  return (
    <section style={{ padding: 'clamp(80px, 10vw, 120px) 0', background: 'var(--brand)', color: '#fff', textAlign: 'center' }}>
      <div className="container" style={{ maxWidth: 800 }}>
        ...
        <p style={{ fontSize: 'clamp(18px, 2.5vw, 22px)', opacity: 0.9, marginBottom: 40, lineHeight: 1.6 }}>Join thousands of {stateName} residents who have transitioned to clinical GLP-1 telehealth.</p>
        <a href={SEMAGLUTIDE_URL} style={{ display: 'inline-block', background: '#fff', color: 'var(--brand)', fontSize: 20, padding: '20px 48px', fontWeight: 600, borderRadius: 100, textDecoration: 'none', boxShadow: '0 10px 30px rgba(0,0,0,0.1)' }}>
          Begin {stateName} Evaluation
        </a>
      </div>
    </section>
  );
