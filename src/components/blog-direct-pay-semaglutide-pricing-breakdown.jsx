...
export function BlogDirectPaySemaglutide() {
  return (
    <section className="section" style={{ minHeight: '60vh', paddingTop: 120, paddingBottom: 100 }}>
      <div className="container" style={{ maxWidth: 840, margin: '0 auto', padding: '0 20px' }}>
        ...
        <h1 className="serif" style={{ fontSize: 44, marginBottom: 20, lineHeight: 1.15, color: 'var(--ink, #1A1F1C)' }}>
          Direct Pay Semaglutide: Transparent Pricing & Fee Audit
        </h1>
        ...
        <div style={{ borderRadius: 16, overflow: 'hidden', marginBottom: 32, boxShadow: '0 8px 30px rgba(0,0,0,0.08)' }}>
          <Image
            src="/assets/direct_pay_semaglutide.jpg"
            alt="Direct-pay medical invoice demonstrating zero hidden fees and transparent cash pricing"
            width={1200}
            height={675}
        ...
        <AIQuickSummaryAction
          ...
          keyPoints={[
            ...
            { label: "Transparent Pricing", value: "Then $190–$199/mo · $0 consult · $0 shipping · $0 dues" },
        ...
        <DirectAnswerSnippet
          question="How does direct pay semaglutide eliminate hidden fees and insurance delays?"
          answer="Direct pay semaglutide provides complete financial transparency, eliminating surprise facility bills and insurance deductible barriers. Telehealth FX delivers physician-supervised compounded semaglutide from state-licensed 503A compounding pharmacies starting at $99 for the first month promo, then $190 to $199 monthly under Section 503A of the FD&C Act, covering medical evaluations, supplies, and cold shipping with zero hidden charges."
          keyTakeaways={[
            { "label": "Regulatory Framework", "value": "100% Legal 503A Compounding (21 U.S.C. § 353a)" },
            { "label": "Direct Cash Price", "value": "$99 / 1st mo (Then $190–$199/mo · $0 consult · $0 shipping · $0 dues)" },
            { "label": "Affirm Financing", "value": "Pay over time starting from ~$25/month" },
        ...
        <div className="blog-content" style={{ fontSize: 18, lineHeight: 1.75, color: 'var(--ink-2, #333C36)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, margin: '24px 0 40px' }}>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>What does direct-pay healthcare mean for GLP-1 weight loss?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>Direct pay means you pay a transparent, all-inclusive cash price directly to the telehealth provider. You bypass insurance prior authorization denials, co-pays, and deductible requirements entirely.</p>
            </div>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>Are there recurring membership or platform subscription fees?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>No. Telehealth FX charges zero monthly subscription dues. You only pay for your medication refills when you need them.</p>
            </div>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>Can I use HSA or FSA funds to pay for direct-pay semaglutide?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>Yes. Because compounded semaglutide is prescribed by licensed doctors for medically supervised weight loss and obesity management, it is typically eligible for HSA/FSA reimbursement.</p>
            </div>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>What happens if my medical history is not approved by the physician?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>If the board-certified doctor determines that GLP-1 therapy is medically contraindicated for you, your payment is 100% refunded immediately.</p>
            </div>
          </div>
