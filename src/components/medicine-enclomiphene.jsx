...
function EnclomiphenePage() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "MedicalWebPage",
        "@id": "https://telehealthfx.com/medications/enclomiphene/#webpage",
        "name": "Enclomiphene (Oral TRT) | Boost Testosterone Naturally | Telehealth FX",
        "description": "Enclomiphene prescribed online — a groundbreaking oral alternative to injectable TRT that boosts your body's own testosterone production up to 2.5x while preserving fertility and testicular function.",
        ...
        "medicalAudience": {
          ...
          "healthCondition": {
            ...
            "alternateName": "Low Testosterone",
            "code": {
              "@type": "MedicalCode",
              "code": "E29.1",
              "codingSystem": "ICD-10"
            ...
            "signOrSymptom": [
              { "@type": "MedicalSymptom", "name": "Low energy and chronic fatigue" },
              { "@type": "MedicalSymptom", "name": "Decreased libido" },
              { "@type": "MedicalSymptom", "name": "Difficulty building muscle" },
              { "@type": "MedicalSymptom", "name": "Brain fog and poor concentration" },
              { "@type": "MedicalSymptom", "name": "Mood changes and irritability" }
            ]
          }
        },
        "about": {
          ...
          "mechanismOfAction": "Selectively blocks estrogen receptors in the hypothalamus and pituitary gland, removing negative feedback inhibition and stimulating increased endogenous production of LH and FSH, which in turn drives the testes to produce more testosterone naturally while preserving spermatogenesis.",
          "administrationRoute": "Oral",
          "dosageForm": "Capsule",
          "activeIngredient": "Enclomiphene Citrate",
          "prescriptionStatus": "PrescriptionOnly",
          "availableStrength": ["12.5mg", "25mg"],
          "description": "Treatment of secondary hypogonadism; testosterone optimization with fertility preservation",
          "warning": "Possible side effects include headache, nausea, mood changes, hot flushes, and acne if levels rise significantly. Contraindicated in known hypersensitivity, primary hypogonadism (testicular failure), and use in women."
        },
        "publisher": {
      ...
      {
        "@type": "FAQPage",
        "@id": "https://telehealthfx.com/medications/enclomiphene/#faq",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is Enclomiphene?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Enclomiphene is the purified trans-isomer of Clomiphene Citrate (Clomid). It's a selective estrogen receptor modulator (SERM) that stimulates your body to produce more testosterone naturally by blocking estrogen feedback at the pituitary gland — increasing LH and FSH output without shutting down your own production."
            }
          },
          {
            "@type": "Question",
            "name": "How is it different from injectable TRT?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Injectable TRT replaces your natural testosterone with exogenous hormone, which shuts down your body's own production, shrinks the testes, and suppresses fertility. Enclomiphene works with your body — stimulating natural production so your testes, fertility, and downstream hormones remain intact."
            }
          },
          {
            "@type": "Question",
            "name": "Will it affect my fertility?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "No — this is one of Enclomiphene's biggest advantages. Unlike injectable TRT, which suppresses sperm production, Enclomiphene actually increases LH and FSH, which supports spermatogenesis. It's often the preferred option for men who want to optimize testosterone while preserving fertility."
            }
          },
          {
            "@type": "Question",
            "name": "How much can testosterone increase?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Clinical studies show Enclomiphene can increase endogenous testosterone production by up to 2.5x from baseline in men with secondary hypogonadism. Individual results vary based on baseline levels, age, and response."
            }
          },
          {
            "@type": "Question",
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Side effects are generally mild and may include headache, nausea, mood changes, hot flushes, and acne. Because Enclomiphene is the purified isomer of Clomid, it has fewer estrogenic side effects than traditional Clomiphene Citrate."
            }
          },
          {
            "@type": "Question",
            "name": "Do I need injections?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "No. Enclomiphene is taken orally as a daily capsule — no injections, no topical creams, no messy application. It's the most convenient form of testosterone optimization available."
            }
          }
        ]
      }
