...
export function LocationAlbuquerque() {
  return (
    <div style={{ background: '#FBF8F3', overflow: 'hidden' }}>
          ...
          <div className="row align-items-center justify-content-center text-center text-lg-start">
            <div className="col-lg-8">
              ...
              <p style={{ fontSize: 'clamp(16px, 2vw, 20px)', opacity: 0.9, marginBottom: 40, lineHeight: 1.6, maxWidth: 650, marginInline: 'auto' }} className="ms-lg-0">
                Skip the gridlock at the Big I and the premium markups at Nob Hill medical spas. Access U.S.-licensed compounded Semaglutide and Tirzepatide, delivered directly to your door anywhere in the Duke City.
              </p>
           ...
           <div className="row g-5 align-items-center">
              <div className="col-lg-6">
                 ...
                 <p style={{ fontSize: 'clamp(16px, 2vw, 18px)', color: 'var(--ink-2)', marginBottom: 24, lineHeight: 1.7 }}>
                    Navigating metabolic health in Albuquerque presents a unique physiological challenge. The combination of high desert altitude (over 5,000 feet) and intense, dry summer heat makes outdoor cardiovascular exercise exceedingly difficult for much of the year, naturally inducing seasonal sedentary behavior.
                 </p>
              ...
              <div className="col-lg-5 offset-lg-1">
                 <div style={{ 
                   ...
                   border: '1px solid rgba(0,0,0,0.05)'
                    ...
                    <p style={{ color: 'var(--ink-2)', fontSize: 15, marginBottom: 24 }}>Our 503A pharmacies ship cold-packed medications directly to your home across Greater Albuquerque:</p>
                    
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 16 }}>
                       {['Northeast Heights', 'Nob Hill', 'Rio Rancho', 'Los Ranchos', 'Corrales', 'Downtown', 'Uptown', 'South Valley'].map(region => (
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-10 text-center">
              <h2 className="serif" style={{ fontSize: 'clamp(32px, 5vw, 56px)', marginBottom: 24 }}>The Albuquerque Cost Arbitrage</h2>
              ...
              <div className="row g-4 text-start">
                <div className="col-md-6">
                  <div style={{ 
                    ...
                    <h3 className="serif" style={{ fontSize: 32, marginBottom: 16 }}>Heights MedSpas</h3>
                    <p style={{ opacity: 0.7, marginBottom: 32, lineHeight: 1.6 }}>
                      Visiting a boutique anti-aging clinic in the Northeast Heights, Nob Hill, or Uptown requires paying a massive premium for the zip code and aesthetics.
                    </p>
           ...
           <div className="row g-5">
              <div className="col-lg-6">
                 <div style={{ display: 'inline-block', background: 'var(--surface-2)', padding: '6px 16px', borderRadius: 100, fontSize: 13, fontWeight: 600, color: 'var(--brand)', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 24 }}>
                    Albuquerque Supply Chain Reality
                 </div>
                 <h2 className="serif" style={{ fontSize: 'clamp(32px, 4vw, 40px)', marginBottom: 24, lineHeight: 1.2 }}>Bypass The Big I & UNM Waitlists</h2>
                 <p style={{ fontSize: 'clamp(16px, 2vw, 18px)', color: 'var(--ink-2)', marginBottom: 24, lineHeight: 1.7 }}>
                 ...
                 <div style={{ background: '#fff', padding: 'clamp(24px, 4vw, 40px)', borderRadius: 32, boxShadow: '0 20px 60px rgba(0,0,0,0.05)', border: '1px solid rgba(0,0,0,0.03)' }}>
                    ...
                    <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 32 }}>
                       <li style={{ display: 'flex', gap: 20 }}>
                          ...
                          <div>
                             <strong style={{ display: 'block', fontSize: 18, marginBottom: 8, color: 'var(--ink)' }}>Complete NM Intake</strong>
                       ...
                       <li style={{ display: 'flex', gap: 20 }}>
                          ...
                          <div>
                             ...
                             <span style={{ color: 'var(--ink-2)', fontSize: 15, lineHeight: 1.6 }}>A licensed New Mexico physician reviews your chart and approves your script within 24 hours.</span>
                          </div>
                       </li>
                       <li style={{ display: 'flex', gap: 20 }}>
                          ...
                          <div>
                             ...
                             <span style={{ color: 'var(--ink-2)', fontSize: 15, lineHeight: 1.6 }}>Medication is compounded and shipped cold-packed straight to your door in Greater Albuquerque.</span>
                          </div>
                       </li>
                    </ul>
                 </div>
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-5 text-center text-lg-start">
              <h2 className="serif" style={{ fontSize: 'clamp(32px, 4vw, 40px)', marginBottom: 24 }}>Albuquerque Service Area</h2>
              <p style={{ fontSize: 'clamp(16px, 2vw, 18px)', color: 'var(--ink-2)', marginBottom: 32, lineHeight: 1.7 }}>
                Telehealth FX provides asynchronous medical weight loss and GLP-1 prescribing services to all permanent residents and professionals operating within Albuquerque and the surrounding high desert region.
              </p>
              <div style={{ background: '#FBF8F3', padding: 32, borderRadius: 24, textAlign: 'left' }}>
                 ...
                 <ul style={{ listStyle: 'none', padding: 0, margin: 0, color: 'var(--ink-2)', fontSize: 15, display: 'flex', flexDirection: 'column', gap: 12 }}>
                    <li style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid rgba(0,0,0,0.05)', paddingBottom: 8 }}>
                       <span>Primary Locality</span> <strong>Albuquerque, NM</strong>
                    </li>
                    <li style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid rgba(0,0,0,0.05)', paddingBottom: 8 }}>
                       <span>Coordinates</span> <strong>35.0844° N, 106.6504° W</strong>
                    </li>
                    <li style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                       <span>Counties Served:</span>
                       <strong style={{ lineHeight: 1.4 }}>Bernalillo County, Sandoval County, Valencia County</strong>
                    </li>
                 </ul>
              </div>
            </div>
            <div className="col-lg-7">
               <div style={{ width: '100%', height: '100%', minHeight: 450, borderRadius: 32, overflow: 'hidden', boxShadow: '0 24px 48px rgba(0,0,0,0.08)' }}>
                  <iframe 
                    ...
                    src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Albuquerque,%20NM+(Telehealth%20FX%20Albuquerque)&amp;t=&amp;z=10&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" 
                    frameBorder="0"
                    allowFullScreen>
                  </iframe>
               </div>
      ...
      <section style={{ padding: 'clamp(80px, 10vw, 120px) 0', background: 'var(--brand)', color: '#fff', textAlign: 'center' }}>
         <div className="container" style={{ maxWidth: 800 }}>
            ...
            <p style={{ fontSize: 'clamp(18px, 2.5vw, 22px)', opacity: 0.9, marginBottom: 40, lineHeight: 1.6 }}>Join thousands of New Mexicans who have transitioned to clinical GLP-1 telehealth.</p>
            <a href={SEMAGLUTIDE_URL} style={{ 
               display: 'inline-block',
               background: '#fff', 
               color: 'var(--brand)', 
            ...
            }}>Check Your NM Eligibility Today</a>
         </div>
      </section>
