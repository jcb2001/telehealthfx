    ...
    "@graph": [
      {
        ...
        "medicalAudience": {
          ...
          "healthCondition": {
            ...
            "associatedAnatomy": { "@type": "AnatomicalStructure", "name": "Penile vasculature and corpora cavernosa" },
            "signOrSymptom": [
        ...
        "about": { "@id": "https://telehealthfx.com/medications/ed/#drug-sildenafil" },
        "publisher": { "@id": "https://telehealthfx.com/#organization" }
      },
      {
        "@type": "Drug",
        "@id": "https://telehealthfx.com/medications/ed/#drug-sildenafil",
        "name": "Sildenafil",
      ...
      {
        "@type": "Drug",
        "@id": "https://telehealthfx.com/medications/ed/#drug-tadalafil",
        "name": "Tadalafil",
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": { "@type": "Answer", "text": "Erectile dysfunction (ED) is the inability to achieve or maintain an erection firm enough for satisfactory sexual intercourse. It affects over 50% of men over 40 in some form and can be caused by vascular, hormonal, neurological, or psychological factors." }
          },
          {
            "@type": "Question",
            "name": "What is the difference between Sildenafil and Tadalafil?",
            "acceptedAnswer": { "@type": "Answer", "text": "Both are PDE5 inhibitors that increase blood flow to the penis. Sildenafil (Viagra) works for 4–6 hours and is taken as-needed. Tadalafil (Cialis) lasts up to 36 hours and can also be taken as a low daily dose for continuous coverage." }
          },
          {
            "@type": "Question",
            "name": "How quickly do ED medications work?",
            "acceptedAnswer": { "@type": "Answer", "text": "Sildenafil typically takes effect within 30–60 minutes. Tadalafil can take 30 minutes to 2 hours but lasts significantly longer. Both require sexual stimulation to work." }
          },
          {
            "@type": "Question",
            "name": "Is it safe to get ED medication prescribed online?",
            "acceptedAnswer": { "@type": "Answer", "text": "Yes. Telehealth prescribing of ED medications is fully legal in most U.S. states when conducted by a licensed clinician after a proper medical evaluation. All prescriptions are reviewed for safety and drug interactions." }
          },
          {
            "@type": "Question",
            "name": "Can ED be a sign of other health problems?",
            "acceptedAnswer": { "@type": "Answer", "text": "Yes. ED is often an early indicator of cardiovascular disease, diabetes, hormonal imbalances, or psychological conditions like anxiety and depression. Treating ED and its underlying causes together produces the best outcomes." }
          },
          {
            "@type": "Question",
            "name": "Will my order be discreet?",
            "acceptedAnswer": { "@type": "Answer", "text": "Absolutely. All medications are shipped in plain, unmarked packaging with no indication of the contents. Your privacy is protected at every step." }
          }
        ]
      },
      {
        "@type": "Offer",
        "@id": "https://telehealthfx.com/medications/ed/#offer",
