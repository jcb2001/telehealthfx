    ...
    <section className="section" style={{ minHeight: '60vh', paddingTop: 120 }}>
      <div className="container" style={{ maxWidth: 800 }}>
        ...
        <div className="blog-content" style={{ fontSize: 18, lineHeight: 1.7, color: 'var(--ink-2)' }}>
          <img src="/assets/bioavailability-featured.png" alt="Understanding berberine oral bioavailability and transdermal patches" style={{ width: '100%', borderRadius: 16, marginBottom: 40, border: '1px solid var(--line-soft)', background: '#111' }} />
          ...
          <p style={{ marginBottom: 24 }}>No. As we proved in our <a href="/blog/72-hour-myth" style={{ color: 'var(--brand)', fontWeight: 500 }}>laboratory analysis of the 72-hour patch myth</a>, the active compound in almost all standard matrix patches is entirely depleted within 18 to 24 hours. You must apply a new patch daily to maintain steady-state AMPK activation.</p>
