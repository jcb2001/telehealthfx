...
function BlogCompoundedTirzepatideOnline() {
  return (<><section className="section" style={{ minHeight: '60vh', paddingTop: 120 }}><div className="container" style={{ maxWidth: 800 }}>
    ...
    <div className="blog-content" style={{ fontSize: 18, lineHeight: 1.7, color: 'var(--ink-2)' }}>
      ...
      <h2 className="serif" style={{ fontSize: 32, marginTop: 48, marginBottom: 24, color: 'var(--ink)' }}>Tirzepatide vs. Semaglutide: Why Tirzepatide Is Different</h2>
      <p>Semaglutide activates one receptor (GLP-1). Tirzepatide activates <strong>two: GLP-1 and GIP</strong>. This dual-agonist mechanism produces:</p>
      <ul>
      ...
      <div style={{ overflowX: 'auto', margin: '24px 0' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 15 }}>
          <thead><tr style={{ borderBottom: '2px solid var(--ink)' }}><th style={{ textAlign: 'left', padding: '12px 16px', fontWeight: 600 }}>Option</th><th style={{ textAlign: 'left', padding: '12px 16px', fontWeight: 600 }}>Monthly Cost</th><th style={{ textAlign: 'left', padding: '12px 16px', fontWeight: 600 }}>Insurance Required?</th></tr></thead>
          <tbody>
            <tr style={{ borderBottom: '1px solid var(--line-soft)' }}><td style={{ padding: '12px 16px', fontWeight: 500 }}>Zepbound (brand, weight loss)</td><td style={{ padding: '12px 16px', color: '#DC2626', fontWeight: 600 }}>$1,060</td><td style={{ padding: '12px 16px' }}>Recommended</td></tr>
            <tr style={{ borderBottom: '1px solid var(--line-soft)' }}><td style={{ padding: '12px 16px', fontWeight: 500 }}>Mounjaro (brand, diabetes)</td><td style={{ padding: '12px 16px', color: '#DC2626', fontWeight: 600 }}>$1,023</td><td style={{ padding: '12px 16px' }}>Required for coverage</td></tr>
            <tr style={{ background: '#F0FDF4' }}><td style={{ padding: '12px 16px', fontWeight: 700 }}>Compounded tirzepatide</td><td style={{ padding: '12px 16px', color: 'green', fontWeight: 700, fontSize: 20 }}>$349–$499</td><td style={{ padding: '12px 16px', color: 'green', fontWeight: 600 }}>No</td></tr>
          </tbody>
        </table>
      </div>
      ...
      <ul>
        ...
        <li style={{ marginBottom: 12 }}><strong>Third-party potency and sterility testing</strong> verifies each lot</li>
        <li style={{ marginBottom: 12 }}><strong>Same molecule</strong> as brand-name Mounjaro/Zepbound — different manufacturer, same active ingredient</li>
      </ul>

      <div className="card" style={{ padding: 40, margin: '48px 0', textAlign: 'center', background: '#FFFDF9', borderColor: 'var(--brand)' }}>
        <h3 className="serif" style={{ fontSize: 28, marginBottom: 16, color: 'var(--ink)' }}>The Most Effective GLP-1. Now Accessible.</h3>
        <p style={{ marginBottom: 24, fontSize: 16 }}>Compounded tirzepatide from $349/month. 503A pharmacy partners. Same dual-agonist molecule at a fraction of the brand-name cost.</p>
      ...
      <div style={{ padding: 40, marginTop: 60, borderRadius: 20, background: 'var(--ink)', color: '#FBF8F3', textAlign: 'center' }}>
        <h2 className="serif" style={{ fontSize: 40, marginBottom: 20, color: '#FBF8F3' }}>22.5% Weight Loss. From $349/Month.</h2>
        <p style={{ fontSize: 18, opacity: 0.9, marginBottom: 32, maxWidth: 500, margin: '0 auto 32px' }}>Compounded tirzepatide — the most effective GLP-1, now accessible without insurance.</p>
      ...
      <div style={{ marginTop: 80, paddingTop: 40, borderTop: '1px solid var(--line-soft)', fontSize: 14, color: 'var(--ink-3)' }}>
        ...
        <ol style={{ paddingLeft: 20, display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <li>Eli Lilly. (2026). <em>Zepbound prescribing information</em>. <a href="https://www.zepbound.lilly.com" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--brand)', textDecoration: 'underline' }}>zepbound.lilly.com</a></li>
        </ol>
      </div>
    </div>
  </div></section></>);
}
export { BlogCompoundedTirzepatideOnline };
