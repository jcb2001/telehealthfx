...
function BlogIndex() {
  const articles = [
    ...
    {
      title: "Coptis Chinensis & Berberis Vulgaris: The Botanical Sources of Natural GLP-1 Support",
    ...
    {
      title: "Berberine vs. GLP-1 in 2026: Can 'Natural GLP-1 Support' Actually Compete?",
      description: "We deconstruct the 'Natural GLP-1 Support' hype, analyzing the AMPK metabolic master switch, Dihydroberberine bioavailability, and head-to-head clinical efficacy.",
    ...
    { title: "Compounded Semaglutide vs Wegovy: What's the Difference?", description: "A clinical breakdown comparing compounded semaglutide to brand-name Wegovy — compounded alternative, different pricing, different access pathways.", slug: "/blog/compounded-semaglutide-vs-wegovy-2026", image: "/assets/compounded-semaglutide-vs-wegovy-featured.png", tag: "Product Comparison" },
    ...
    { title: "Zepbound vs Mounjaro vs Compounded Tirzepatide: What's the Difference?", description: "Three access pathways for tirzepatide. Understanding Zepbound (weight loss), Mounjaro (diabetes), and compounded tirzepatide pricing and availability.", slug: "/blog/zepbound-vs-mounjaro-compounded-tirzepatide", image: "/assets/zepbound-vs-mounjaro-featured.png", tag: "Product Comparison" },
