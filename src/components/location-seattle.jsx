    ...
    <div style={{ background: '#FBF8F3', overflow: 'hidden' }}>
          ...
          <div className="row align-items-center justify-content-center text-center text-lg-start">
            <div className="col-lg-8">
              ...
              <p style={{ fontSize: 'clamp(16px, 2vw, 20px)', opacity: 0.9, marginBottom: 40, lineHeight: 1.6, maxWidth: 650, marginInline: 'auto' }} className="ms-lg-0">
                Skip the gridlock on I-5 and the premium markups at Bellevue medical spas. Access U.S.-licensed compounded Semaglutide and Tirzepatide, delivered directly to your door anywhere in King County.
              </p>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 24, marginTop: 40, opacity: 0.8, flexWrap: 'wrap' }} className="justify-content-center justify-content-lg-start">
                 <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    <span style={{ fontSize: 14, fontWeight: 500 }}>Washington Medical Commission Compliant</span>
                 </div>
                 <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <Icon.Check size={18} color="#2ECC71" />
           ...
           <div className="row g-5 align-items-center">
              <div className="col-lg-6">
                 <h2 className="serif" style={{ fontSize: 'clamp(32px, 4vw, 48px)', lineHeight: 1.2, marginBottom: 24, color: 'var(--ink)' }}>
                    The Pacific Northwest Metabolic Reality
                 </h2>
                 <p style={{ fontSize: 'clamp(16px, 2vw, 18px)', color: 'var(--ink-2)', marginBottom: 24, lineHeight: 1.7 }}>
                    Navigating metabolic health in Seattle presents a unique physiological challenge. Nine months of gray, rainy weather actively suppress outdoor mobility, leading to severe seasonal affective dips and prolonged indoor sedentary behavior.
                 </p>
                 <p style={{ fontSize: 'clamp(16px, 2vw, 18px)', color: 'var(--ink-2)', marginBottom: 32, lineHeight: 1.7 }}>
                    Combine this with high-stress corporate environments at local tech giants and brutal commutes across Lake Washington on SR-520 or the I-405, and traditional diet protocols frequently fail due to cortisol-induced insulin resistance.
                 </p>
                 ...
                 <div style={{ 
                   ...
                   border: '1px solid rgba(0,0,0,0.05)'
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 16 }}>
                       {['Capitol Hill', 'Ballard', 'Queen Anne', 'Bellevue', 'Mercer Island', 'Kirkland', 'Fremont', 'South Lake Union'].map(region => (
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-10 text-center">
              <h2 className="serif" style={{ fontSize: 'clamp(32px, 5vw, 56px)', marginBottom: 24 }}>The Seattle Cost Arbitrage</h2>
              ...
              <div className="row g-4 text-start">
                <div className="col-md-6">
                  <div style={{ 
                    ...
                    <h3 className="serif" style={{ fontSize: 32, marginBottom: 16 }}>Bellevue and Mercer Island MedSpas</h3>
                    <p style={{ opacity: 0.7, marginBottom: 32, lineHeight: 1.6 }}>
                      Visiting a boutique anti-aging clinic in Bellevue and Mercer Island requires paying a massive premium for the zip code.
                    </p>
                    <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 16 }}>
                      <li style={{ display: 'flex', gap: 16 }}>
                        <div style={{ color: '#e74c3c', marginTop: 2 }}><Icon.Minus size={20} /></div>
                        <span style={{ opacity: 0.9 }}>Average Cost: <strong style={{ color: '#fff' }}>$700 - $1,000 / month</strong></span>
                      </li>
                      <li style={{ display: 'flex', gap: 16 }}>
                        <div style={{ color: '#e74c3c', marginTop: 2 }}><Icon.Minus size={20} /></div>
        ...
        <div className="container">
           <div className="row g-5">
              <div className="col-lg-6">
                 ...
                 <h2 className="serif" style={{ fontSize: 'clamp(32px, 4vw, 40px)', marginBottom: 24, lineHeight: 1.2 }}>Bypass I-5 and I-405 & Waitlists</h2>
                 <p style={{ fontSize: 'clamp(16px, 2vw, 18px)', color: 'var(--ink-2)', marginBottom: 24, lineHeight: 1.7 }}>
                    Whether you're enduring dead-stop traffic on I-5 and I-405, spending an hour in your car just to sit in a doctor's waiting room for a 5-minute prescription refill is an outdated model.
                 </p>
                 <p style={{ fontSize: 'clamp(16px, 2vw, 18px)', color: 'var(--ink-2)', marginBottom: 32, lineHeight: 1.7 }}>
                    Even worse, if you try to fill a prescription for branded Wegovy at Fred Meyer and Bartell Drugs, you know the reality: <strong>the medications are on indefinite national backorder.</strong> Furthermore, securing an appointment at metabolic centers like <strong>UW Medicine and Swedish Health Services</strong> takes 4-6 months, and local insurance plans frequently deny prior authorizations.
                 </p>
                 ...
                 <div style={{ background: '#fff', padding: 'clamp(24px, 4vw, 40px)', borderRadius: 32, boxShadow: '0 20px 60px rgba(0,0,0,0.05)', border: '1px solid rgba(0,0,0,0.03)' }}>
                    ...
                    <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 32 }}>
                       <li style={{ display: 'flex', gap: 20 }}>
                          ...
                          <div>
                             <strong style={{ display: 'block', fontSize: 18, marginBottom: 8, color: 'var(--ink)' }}>Complete WA Intake</strong>
                       ...
                       <li style={{ display: 'flex', gap: 20 }}>
                          ...
                          <div>
                             ...
                             <span style={{ color: 'var(--ink-2)', fontSize: 15, lineHeight: 1.6 }}>A licensed Washington physician reviews your chart and approves your script within 24 hours.</span>
                          </div>
                       </li>
                       <li style={{ display: 'flex', gap: 20 }}>
                          ...
                          <div>
                             ...
                             <span style={{ color: 'var(--ink-2)', fontSize: 15, lineHeight: 1.6 }}>Medication is compounded and shipped cold-packed straight to your door in Seattle.</span>
                          </div>
                       </li>
                    </ul>
                 </div>
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-5 text-center text-lg-start">
              <h2 className="serif" style={{ fontSize: 'clamp(32px, 4vw, 40px)', marginBottom: 24 }}>Seattle Service Area</h2>
              <p style={{ fontSize: 'clamp(16px, 2vw, 18px)', color: 'var(--ink-2)', marginBottom: 32, lineHeight: 1.7 }}>
                Telehealth FX provides asynchronous medical weight loss and GLP-1 prescribing services to all permanent residents and professionals operating within Seattle and surrounding counties.
              </p>
              <div style={{ background: '#FBF8F3', padding: 32, borderRadius: 24, textAlign: 'left' }}>
                 ...
                 <ul style={{ listStyle: 'none', padding: 0, margin: 0, color: 'var(--ink-2)', fontSize: 15, display: 'flex', flexDirection: 'column', gap: 12 }}>
                    <li style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid rgba(0,0,0,0.05)', paddingBottom: 8 }}>
                       <span>Primary Locality</span> <strong>Seattle, WA</strong>
                    </li>
                    <li style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid rgba(0,0,0,0.05)', paddingBottom: 8 }}>
                       <span>Coordinates</span> <strong>47.6062° N, 122.3321° W</strong>
                    </li>
                    <li style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                       <span>Counties Served:</span>
                       <strong style={{ lineHeight: 1.4 }}>King County, Snohomish County, Pierce County</strong>
                    </li>
                 </ul>
              </div>
            </div>
            <div className="col-lg-7">
               <div style={{ width: '100%', height: '100%', minHeight: 450, borderRadius: 32, overflow: 'hidden', boxShadow: '0 24px 48px rgba(0,0,0,0.08)' }}>
                  <iframe 
                    ...
                    src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Seattle,%20WA+(Telehealth%20FX%20Seattle)&amp;t=&amp;z=10&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" 
                    frameBorder="0"
                    allowFullScreen>
                  </iframe>
               </div>
      ...
      <section style={{ padding: 'clamp(80px, 10vw, 120px) 0', background: 'var(--brand)', color: '#fff', textAlign: 'center' }}>
         <div className="container" style={{ maxWidth: 800 }}>
            ...
            }}>Check Your WA Eligibility Today</a>
         </div>
      </section>
    </div>
  );
