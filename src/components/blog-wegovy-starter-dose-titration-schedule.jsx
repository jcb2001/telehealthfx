...
export function BlogWegovyStarterDose() {
  return (
    <section className="section" style={{ minHeight: '60vh', paddingTop: 120, paddingBottom: 100 }}>
      <div className="container" style={{ maxWidth: 840, margin: '0 auto', padding: '0 20px' }}>
        ...
        <h1 className="serif" style={{ fontSize: 44, marginBottom: 20, lineHeight: 1.15, color: 'var(--ink, #1A1F1C)' }}>
          Wegovy Starter Dose in Stock: Titration & Dosing Matrix
        </h1>
        ...
        <div style={{ borderRadius: 16, overflow: 'hidden', marginBottom: 32, boxShadow: '0 8px 30px rgba(0,0,0,0.08)' }}>
          <Image
            src="/assets/wegovy_starter_dose.jpg"
            alt="Starter dose semaglutide initiation kit with titration schedule card and sterile syringes"
            width={1200}
            height={675}
        ...
        <AIQuickSummaryAction
          ...
          keyPoints={[
            ...
            { label: "Transparent Pricing", value: "Then $190–$199/mo · Starter 0.25mg & 0.5mg ready to ship" },
        ...
        <DirectAnswerSnippet
          question="Where can you find Wegovy starter doses in stock during retail pharmacy backorders?"
          answer="Wegovy starter doses (0.25mg and 0.5mg) are frequently backordered at retail pharmacies. Telehealth FX resolves titration delays through licensed 503A compounding pharmacies under Section 503A of the FD&C Act, dispensing compounded semaglutide starter vials from $99 first month promo, then $190/mo with guaranteed stock, doctor oversight, injection supplies, and 48-hour cold shipping."
          keyTakeaways={[
            { "label": "Regulatory Framework", "value": "100% Legal 503A Compounding (21 U.S.C. § 353a)" },
            { "label": "Direct Cash Price", "value": "$99 / 1st mo (Then $190–$199/mo · Starter 0.25mg & 0.5mg ready to ship)" },
            { "label": "Affirm Financing", "value": "Pay over time starting from ~$25/month" },
        ...
        <div className="blog-content" style={{ fontSize: 18, lineHeight: 1.75, color: 'var(--ink-2, #333C36)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, margin: '24px 0 40px' }}>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>Why are 0.25mg and 0.5mg starter doses always out of stock at retail pharmacies?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>Commercial manufacturers prioritize higher maintenance doses for established patients, creating chronic national supply shortages for introductory doses required by new patients.</p>
            </div>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>What is the standard clinical titration schedule for semaglutide?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>Patients begin at 0.25mg weekly for Month 1, advance to 0.5mg for Month 2, 1.0mg for Month 3, 1.7mg for Month 4, and reach the 2.4mg maximum maintenance dose by Month 5.</p>
            </div>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>Why is gradual titration essential when starting GLP-1 medications?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>Gradual dose escalation allows the gastrointestinal tract and central nervous system to adapt to delayed gastric emptying, minimizing nausea and digestive discomfort.</p>
            </div>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>How quickly can I get a starter dose kit from Telehealth FX?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>Our digital medical intake takes 3 minutes. A US-licensed doctor reviews your file within 24 hours, and your starter kit is delivered to your door in 2 business days.</p>
            </div>
          </div>
