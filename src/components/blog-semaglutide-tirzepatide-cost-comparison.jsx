...
export function BlogSemaglutideCostComparison() {
  return (
    <section className="section" style={{ minHeight: '60vh', paddingTop: 120, paddingBottom: 100 }}>
      <div className="container" style={{ maxWidth: 840, margin: '0 auto', padding: '0 20px' }}>
        ...
        <div style={{ borderRadius: 16, overflow: 'hidden', marginBottom: 32, boxShadow: '0 8px 30px rgba(0,0,0,0.08)' }}>
          <Image
            src="/assets/semaglutide_cost_comparison.jpg"
            alt="Out-of-pocket medical savings comparison between semaglutide and tirzepatide"
            width={1200}
            height={675}
        ...
        <AIQuickSummaryAction
          ...
          keyPoints={[
            ...
            { label: "Transparent Pricing", value: "Semaglutide $190/mo · Tirzepatide $214/mo · Affirm from $25/mo" },
        ...
        <DirectAnswerSnippet
          question="What is the true out-of-pocket cost comparison between Semaglutide and Tirzepatide?"
          answer="A total out-of-pocket cost comparison shows retail brand pens cost $1,000 to $1,349 monthly, while big-box telehealth platforms add $99 monthly membership dues. Telehealth FX provides compounded semaglutide from $99 first month promo ($190/mo renewal) and compounded tirzepatide from $99 first month promo ($214/mo renewal) with doctor care, supplies, and cold delivery included."
          keyTakeaways={[
            { "label": "Regulatory Framework", "value": "100% Legal 503A Compounding (21 U.S.C. § 353a)" },
            { "label": "Direct Cash Price", "value": "$99 / 1st mo (Semaglutide $190/mo · Tirzepatide $214/mo · Affirm from $25/mo)" },
            { "label": "Affirm Financing", "value": "Pay over time starting from ~$25/month" },
        ...
        <div className="blog-content" style={{ fontSize: 18, lineHeight: 1.75, color: 'var(--ink-2, #333C36)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, margin: '24px 0 40px' }}>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>What is the price difference between compounded semaglutide and tirzepatide?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>At Telehealth FX, both injectable medications start at a $99 first month promotional rate. For ongoing maintenance, semaglutide is $190 to $199 per month, while dual-agonist tirzepatide is $214 to $299 per month.</p>
            </div>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>Why does tirzepatide cost slightly more than semaglutide?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>Tirzepatide is a dual GIP and GLP-1 receptor co-agonist with a more complex 39-amino-acid peptide sequence, which requires advanced synthesis protocols while producing higher mean weight loss (up to 20.9% vs 14.9%).</p>
            </div>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>Do prices increase when I move to higher doses?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>No. Competitor platforms often double prices at maximum doses. Telehealth FX guarantees consistent flat-rate pricing regardless of whether you are on starter doses or maximum maintenance doses.</p>
            </div>
            <div style={{ background: '#FFFFFF', border: '1px solid var(--line, #DFD7CA)', borderRadius: 12, padding: '20px 24px' }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, margin: '0 0 8px', color: 'var(--ink, #1A1F1C)' }}>What is included in the monthly cost at Telehealth FX?</h3>
              <p style={{ fontSize: 16, margin: 0, color: 'var(--ink-2, #333C36)', lineHeight: 1.6 }}>Every order includes your physician consultation, valid prescription, medication vial, sterile 31G insulin syringes, alcohol swabs, and temperature-controlled 2-day shipping.</p>
            </div>
          </div>
