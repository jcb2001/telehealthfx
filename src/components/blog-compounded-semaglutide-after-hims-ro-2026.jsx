...
function BlogCompoundedAfterHimsRo() {
  return (<><section className="section" style={{ minHeight: '60vh', paddingTop: 120 }}><div className="container" style={{ maxWidth: 800 }}>
    <div style={{ display: 'inline-block', padding: '4px 12px', borderRadius: 6, background: '#DC2626', color: '#fff', fontSize: 12, fontWeight: 700, letterSpacing: 1, textTransform: 'uppercase', marginBottom: 16 }}>Breaking — May 2026</div>
    <h1 className="serif" style={{ fontSize: 52, marginBottom: 24, lineHeight: 1.08 }}>Hims and Ro Stopped Selling Compounded Semaglutide. <span style={{ fontStyle: 'italic', color: 'var(--brand)' }}>Here Is Where to Get It Now.</span></h1>
    <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 48, paddingBottom: 24, borderBottom: '1px solid var(--line-soft)' }}><div style={{ width: 40, height: 40, borderRadius: '50%', background: 'var(--brand)' }}><Image src="/assets/jm-profile.jpg" alt="Julian Mercer" width={1024} height={1024} style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '50%', height: "auto"}} priority={true} /></div><div><div style={{ fontWeight: 500, fontSize: 14 }}><a href="/about" style={{ color: "var(--ink)", textDecoration: "none" }}>Julian Mercer, M.S.</a></div><div style={{ fontSize: 13, color: 'var(--ink-3)' }}>Lead Bio-Systems Analyst · Updated May 7, 2026 · 18 min read</div></div></div>
    <div className="blog-content" style={{ fontSize: 18, lineHeight: 1.7, color: 'var(--ink-2)' }}>
      ...
      <ul>
        <li style={{ marginBottom: 8 }}>✅ Same compounded semaglutide, same price range ($199–$399/month)</li>
      ...
      <div style={{ padding: 40, margin: '48px 0', borderRadius: 20, background: 'linear-gradient(135deg, #0F172A, #1E293B)', color: '#FBF8F3', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 13, opacity: 0.6, marginTop: 16 }}>All-inclusive pricing from $199/mo · HSA/FSA accepted · Ships in 3–5 business days</p>
      </div>
