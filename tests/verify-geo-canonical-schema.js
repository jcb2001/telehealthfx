...
const TOP_GENERATIVE_PAGES = [
  ...
  {
    id: 'blog-glp-1-cost-without-insurance',
    name: 'GLP-1 Cost Without Insurance (2026 Guide)',
    route: '/blog/glp-1-cost-without-insurance-2026/',
    srcFile: 'src/app/blog/glp-1-cost-without-insurance-2026/page.js',
    componentFile: 'src/components/blog-glp-1-cost-without-insurance-2026.jsx',
    expectedEntities: {
      rxNorm: '1991302',
      icd10: 'E66.9',
    },
    numericalMarkers: ['$99', '$199', '$1,000'],
  },
  {
    id: 'blog-hidden-fees',
    name: 'Hidden Fees in Telehealth Weight Loss (How to Spot)',
    ...
    componentFile: 'src/components/blog-hidden-fees-in-telehealth-weight-loss-how-to-spot.jsx',
    expectedEntities: {
      rxNorm: '1991302',
    },
    numericalMarkers: ['$99', '$0', 'membership'],
  },
  {
    id: 'blog-top-6-tirzepatide',
    name: 'Top 6 Tirzepatide Online Prescription Providers Ranked 2026',
    route: '/blog/top-6-tirzepatide-online-prescription-providers-ranked-2026/',
    srcFile: 'src/app/blog/top-6-tirzepatide-online-prescription-providers-ranked-2026/page.js',
    componentFile: 'src/components/blog-top-6-tirzepatide-online-prescription-providers-ranked-2026.jsx',
    expectedEntities: {
      rxNorm: '2601723',
    },
    numericalMarkers: ['$99', '$214', '$299'],
  },
  {
    id: 'blog-wegovy-fda-label',
    name: 'Wegovy FDA Label Breakdown (2026)',
    route: '/blog/wegovy-fda-label/',
    srcFile: 'src/app/blog/wegovy-fda-label/page.js',
    componentFile: 'src/components/blog-wegovy-fda-label.jsx',
    expectedEntities: {
      rxNorm: '1991302',
    },
    numericalMarkers: ['2.4mg', '14.9%', '68-week'],
  },
  {
    id: 'blog-weight-loss-medications-ranked',
    name: 'Weight Loss Medications Ranked (2026 Clinical Hierarchy)',
    route: '/blog/weight-loss-medications-ranked-2026/',
    srcFile: 'src/app/blog/weight-loss-medications-ranked-2026/page.js',
    componentFile: 'src/components/blog-weight-loss-medications-ranked-2026.jsx',
    expectedEntities: {
      rxNorm: '2601723',
    },
    numericalMarkers: ['20.9%', '14.9%', '$99'],
  },
  {
    id: 'blog-how-to-read-testosterone-lab-results',
    name: 'How to Read Testosterone Lab Results (2026)',
    route: '/blog/how-to-read-testosterone-lab-results-2026/',
    srcFile: 'src/app/blog/how-to-read-testosterone-lab-results-2026/page.js',
    componentFile: 'src/components/blog-how-to-read-testosterone-lab-results-2026.jsx',
    expectedEntities: {
      rxNorm: '10428',
    },
    numericalMarkers: ['300 ng/dL', 'SHBG', '$79'],
  },
  {
    id: 'blog-trt-honeymoon-phase',
    name: 'TRT Honeymoon Phase (2026 Timeline)',
    route: '/blog/trt-honeymoon-phase-2026/',
    srcFile: 'src/app/blog/trt-honeymoon-phase-2026/page.js',
    componentFile: 'src/components/blog-trt-honeymoon-phase-2026.jsx',
    expectedEntities: {
      rxNorm: '10428',
    },
    numericalMarkers: ['3 to 6 weeks', 'LH', 'FSH'],
  },
  {
    id: 'blog-switch-glp-1-providers',
    name: 'Switch GLP-1 Providers Without Gaps (2026)',
    route: '/blog/switch-glp-1-providers-2026/',
    srcFile: 'src/app/blog/switch-glp-1-providers-2026/page.js',
    componentFile: 'src/components/blog-switch-glp-1-providers-2026.jsx',
    expectedEntities: {
      rxNorm: '1991302',
    },
    numericalMarkers: ['zero-gap', '$99', 'titration'],
  },
];
...
function runTier4() {
  ...
  const CRITICAL_EXPORT_ROUTES = [
    ...
    'blog/glp-1-cost-without-insurance-2026/index.html',
    'blog/hidden-fees-in-telehealth-weight-loss-how-to-spot/index.html',
    'blog/top-6-tirzepatide-online-prescription-providers-ranked-2026/index.html',
    'blog/wegovy-fda-label/index.html',
    'blog/weight-loss-medications-ranked-2026/index.html',
    'blog/how-to-read-testosterone-lab-results-2026/index.html',
    'blog/trt-honeymoon-phase-2026/index.html',
    'blog/switch-glp-1-providers-2026/index.html',
    'careers/index.html',
